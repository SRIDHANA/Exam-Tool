...
<script type="text/javascript">
    $(document).ready(function () {
        $('#TableContainer').jtable({
        	...
        	paging: true,
            actions: {
                listAction:'manageCourse?action=list',
                	 createAction:'manageCourse?action=create',
                     updateAction: 'manageCourse?action=update',
                     deleteAction: 'manageCourse?action=delete' 
             },
            fields: {
               courseid: {
                	title:'Course ID',
                ...
                coursename: {
                    ...
                    edit:true,
                    columnResizable:true
                   // options: ['Bob', 'Smith', 'cargSmith' ,  'sweehtaSmith' , 'lkjlk'  ]
                }                
            }
        });
