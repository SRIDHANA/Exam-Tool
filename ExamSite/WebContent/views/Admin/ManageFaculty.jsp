...
<script type="text/javascript">
    $(document).ready(function () {
        $('#TableContainer').jtable({
        	...
        	paging: true,
            actions: {
                listAction:'manageFaculty?action=list',
                createAction:'manageFaculty?action=create',
                updateAction: 'manageFaculty?action=update',
                deleteAction: 'manageFaculty?action=delete' 
             },
            fields: {
                username:
					{
