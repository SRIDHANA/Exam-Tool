...
<script type="text/javascript">
    $(document).ready(function () {
        $('#TableContainer').jtable({
        	...
        	paging: true,
            actions: {
                listAction:'manageStudentAssignments?action=list',
                createAction:'manageStudentAssignments?action=create',
                updateAction: 'manageStudentAssignments?action=update',
                deleteAction: 'manageStudentAssignments?action=delete' 
             },
            fields: {
                classid:
					{
