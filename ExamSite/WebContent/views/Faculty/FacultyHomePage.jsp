...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
 ...
 Dear Faculty,
<br>
You can upload your questions and maintain them in the tool throught the links on the left menu.
<br>
You can create an exam pattern and generate question papers in the Exam Pattern Link on the left menu. 
>
  </div>
  <!-- /.container-fluid-->
  <!-- /.content-wrapper-->
