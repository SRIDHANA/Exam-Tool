...
<label> List of Classes Available	</label>					
				...
				<table >
					...
					<c:forEach items="${ClassMaplist}" var="classMap">
						<tr>
							<td><a href="<c:url value='/studentclassidlinks/${classMap.classid}' />" >${classMap.classid}</a></td>
					<c:forEach items="${ClassBeanlist}" var="classBean"  >
					      <c:if  test="${classMap.classid eq classBean.classid}" >	
